...
RUN apt-get update && apt-get install -y --no-install-recommends \
        ...
        cuda-npp-dev-${CUDA/./-} \
        cuda-nvgraph-dev-${CUDA/./-} \
        cuda-nvjpeg-dev-${CUDA/./-} \
        cuda-nvml-dev-${CUDA/./-} \
        cuda-nvrtc-dev-${CUDA/./-} \
        curl \
...
RUN pip install --upgrade pip && pip install tensorflow-gpu==2.2.0 keras pydot gensim theano word2vec pandas keras-word-char-embd word-embedder sklearn virtualenv eli5 keras.models cairocffi editdistance argparse matplotlib extra-keras-datasets librosa google-colab 
...
RUN git clone https://github.com/tensorflow/docs.git
